...
if __name__ == "__main__":
    # Standalone demo: solves the simple non-convex problem from the report
    # and plots convergence. Only runs when this file is executed directly,
    # not when SQP() is imported by another script.
    n = 20
    m = 30
    np.random.seed(1)
